...
def main():
    with sync_playwright() as p:
        ...
        # Step 2: Login with credentials - using proper selectors for Django form
        print("\n[Step 2] Logging in with admin/pawssword...")
        ...
        page.fill('input[name="password"]', 'pawssword')
        ...
        page.wait_for_load_state('networkidle')
        page.wait_for_timeout(3000)  # Extra wait for redirect
        ...
        if '/accounts/login/' in current_url:
            ...
            print("  [OK] Redirected after login")
        ...
        if not button_found:
            ...
            if not modal_found:
                print("  [WARNING] No modal detected - checking for blank page...")
            
            # Check body content after click
        ...
        # Check for issues
        has_issues = bool(page_errors or error_logs or len(body_text) < 100)
        ...
        if has_issues:
            ...
            print("\n[OK] All checks passed - Page is working correctly")
